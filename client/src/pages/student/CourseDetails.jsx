          ...
          <div className="p-5">
            ...
            <div className="flex gap-3 items-center pt-2">
              <p className="text-gray-800 md:text-4xl text-2xl font-semibold">
                {currency}{(courseData?.coursePrice - (courseData?.discount || 0) * (courseData?.coursePrice || 0)/100).toFixed(2)}
              </p>
            ...
            <button onClick={enrolledCourses} className="md:mt-6 mt-4 w-full py-3 rounded bg-blue-600 text-white font-medium hover:bg-blue-700 transition-colors">
